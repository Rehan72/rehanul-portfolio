          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 p-4 rounded-lg bg-card/50 border border-white/10 hover:border-accent/20 transition-all duration-300">
              ...
              <div>
                ...
                <a href="mailto:syed.rehanhaque1994@gmail.com" className="text-accent hover:underline">syed.rehanhaque1994@gmail.com</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 rounded-lg bg-card/50 border border-white/10 hover:border-accent2/20 transition-all duration-300">
              ...
              <div>
                ...
                <a href="tel:+917277826285" className="text-accent hover:underline">+91 72778 26285</a>
              </div>
            </div>

            <div className="flex items-center gap-4 p-4 rounded-lg bg-card/50 border border-white/10 hover:border-green-500/20 transition-all duration-300">
              <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-accent rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
