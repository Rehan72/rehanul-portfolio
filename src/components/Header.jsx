...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="w-full px-4 md:px-8 lg:px-16 flex items-center justify-between py-6 md:py-8">
        <motion.a
          href="#"
        ...
        <nav className="hidden gap-10 text-base md:flex">
          {navItems.map((item, index) => (
            <motion.a
              key={item.href}
              href={item.href}
              className={`relative transition-colors duration-300 hover:text-accent ${activeSection === item.href.substring(1) ? "text-accent" : "text-muted-foreground"
                }`}
